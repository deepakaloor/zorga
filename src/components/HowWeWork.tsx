...
export function HowWeWork() {
  return (
    <section id="work" aria-labelledby="how-title">
      ...
      <div className="wrap pt-[clamp(4rem,12vh,8rem)] pb-[clamp(5rem,14vh,10rem)]">
        <h2 id="how-title" className="t-display" data-reveal="lines">
          <Ml>Four ways</Ml>
          <Ml>to build with Zorga<span className="text-blue">.</span></Ml>
        </h2>
        <ul className="mt-[clamp(3.5rem,9vh,6.5rem)] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-12 border-t border-rule">
          {ways.map((w, i) => (
